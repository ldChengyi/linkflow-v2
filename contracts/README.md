...
| `device.property.set.requested` | `1` | `events/device.property.set.requested.v1.schema.json` |
...
| `device.service.call.requested` | `1` | `events/device.service.call.requested.v1.schema.json` |
