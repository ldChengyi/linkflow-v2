...
var (
	...
	ErrProductAlreadyExists     = New(http.StatusConflict, "product_already_exists", "product already exists")
	ErrThingsModelAlreadyExists = New(http.StatusConflict, "thingsmodel_already_exists", "thingsmodel already exists")
	ErrDeviceAlreadyExists      = New(http.StatusConflict, "device_already_exists", "device already exists")
